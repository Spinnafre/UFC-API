...
class ShowHighlightsEventsUseCase {
  ...
  async execute() {
    ...
    try {
      ...
      //Eventos em destaque
      const highlightsEvents = await page.$eval(
        ...
        (el) => {
          ...
          activeItems.forEach((item) => {
            ...
            const price =
              ...
              content
                .querySelector(".event-item-price.ticketbox-price")
                .textContent.trim();
      ...
      //Próximos eventos
      const next_events = await page.$eval(
        ...
        (el) => {
          ...
          activeItems.forEach((item) => {
            ...
            const locationDetails = item.querySelector(
      ...
      throw new AppError({
        message: `Falha ao realizar busca de eventos principais . Error -> ${error.message}`,
      });
    }
  }
}
